...
struct PromptResponseTextEntryView: View {
    ...
    init(response: ReflectionResponse,dataController: DataController) {
        self.response = response
        self.dataController = dataController
        
        let newViewModel = ViewModel(dataController: dataController)
...
// MARK: - PREVIEW
#Preview {
    PromptResponseTextEntryView(response: .example, dataController: .preview)
}//: PREVIEw
