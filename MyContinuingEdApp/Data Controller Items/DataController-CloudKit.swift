...
extension DataController {
    ...
    func syncLocalMediaFiles() async {
        NSLog(">>> DataController: Fetching all CKRecord changes in iCloud...")
    ...
    private func handleZoneDeleted(with zoneId: CKRecordZone.ID) async {
        ...
        Task{@MainActor in
            criticalCloudAlertMessage = "The app has been notified that a specific section of your iCloud drive configured for storing media files (for this particular app) has been deleted. The app will recreate an empty section so new files can be added to it, but be aware that whatever files were in that secion will no longer sync across your devices until they are re-uploaded."
        }//: TASK
