...
struct ContentViewToolbarView: View {
    ...
    // for adding an activity and showing the upgrade sheet if criteria are met
    let onAddNewActivity: () -> Void
    ...
    // MARK: - INIT
    init(onAddNewActivity: @escaping () -> Void,) {
        self.onAddNewActivity = onAddNewActivity
    }//: INIT
}//: STRUCt
...
// MARK: - PREVIEW
#Preview {
    ContentViewToolbarView(onAddNewActivity: {})
}
